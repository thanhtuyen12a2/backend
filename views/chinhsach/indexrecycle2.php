...
<p>
    ...
    $countgetAllRecycle1_2 = count($_Chinhsach::getAllRecycle1_2());
    
    if($countgetAllRecycle1_2 > 0){       
        echo '<button type="button"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1_2.'" '.Aabc::$app->d->u.' ="da_bh" class="btn btn-default bda" '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'"><span class="glyphicon glyphicon-ban-circle mden"></span>Xóa tất cả</button>';
    }
     ?>
        ...
        'columns' => [
            ...
            //],
             ...
             [                
                ...
                'value' => function ($model) {  
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1_2 = count($_Chinhsach::getAllRecycle1_2());                                      
                    return '<div class="text-center" ><button   '.Aabc::$app->d->type.'="_bh"   '.Aabc::$app->d->ct.' ="'.$countgetAllRecycle1_2.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="res_bh?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="be glyphicon glyphicon-floppy-open" ></button></div>';                    
                }, 
            ],
            ...
            [           
                ...
                'value' => function ($model) {   
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1_2 = count($_Chinhsach::getAllRecycle1_2());                     
                    return '<div class="text-center" ><button   '.Aabc::$app->d->type.'="_bh"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1_2.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="d_bh?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="bd glyphicon glyphicon-ban-circle" ></button></div>'; 
                }, 
            ],
