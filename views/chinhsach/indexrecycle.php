...
<p>
    ...
    $countgetAllRecycle1 = count($_Chinhsach::getAllRecycle1());
    
    if($countgetAllRecycle1 > 0){       
        echo '<button type="button"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1.'" '.Aabc::$app->d->u.' ="da" class="btn btn-default bda" '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'"><span class="glyphicon glyphicon-ban-circle mden"></span>Xóa tất cả</button>';
    }
     ?>
        ...
        'columns' => [
            ...
            //],
             ...
             [                
                ...
                'value' => function ($model) {  
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1 = count($_Chinhsach::getAllRecycle1());                                      
                    return '<div class="text-center" ><button  '.Aabc::$app->d->ct.' ="'.$countgetAllRecycle1.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="res?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="be glyphicon glyphicon-floppy-open" ></button></div>';                    
                }, 
            ],
            ...
            [           
                ...
                'value' => function ($model) {   
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1 = count($_Chinhsach::getAllRecycle1());                     
                    return '<div class="text-center" ><button '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="d?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="bd glyphicon glyphicon-ban-circle" ></button></div>'; 
                }, 
            ],
