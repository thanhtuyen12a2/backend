            ...
            //  Aabc::$app->_chinhsach->cs_ngaytao,
             ...
             [                
                ...
                'value' => function ($model) {                         
                    ...
                    <button type="button"  '.Aabc::$app->d->m.'="3"  class="mb btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__chinhsach.'  '.Aabc::$app->d->u.'="u_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'">'.Aabc::$app->MyConst->gridview_menu_suachitiet.'<span class="glyphicon glyphicon-pencil"></span></button>

                    <div class="gn"></div>
                    '.                        
                        (Aabc::$app->user->can('web') ?  ($model[Aabc::$app->_chinhsach->cs_status] == 2 ? '<button type="button" class="ml btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__chinhsach.'   '.Aabc::$app->d->u.'="us_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'">Kích hoạt<span class="glyphicon glyphicon-eye-open"></span></button>' : '<button type="button" class="ml btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__chinhsach.'   '.Aabc::$app->d->u.'="us_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'">Ngừng kích hoạt<span class="glyphicon glyphicon-eye-open"></span></button>') : "" )

                    .'
                    <button type="button" class="br btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__chinhsach.'  '.Aabc::$app->d->u.'="rec_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'">'.Aabc::$app->MyConst->gridview_menu_thungrac.'<span class="glyphicon glyphicon-trash"></span></button>
...
<div class="sy0"></div>
 ...
 <div class='cas'>
    ...
    <?= Html::button(Aabc::$app->MyConst->gridview_selectmultiitem_thuchien, [Aabc::$app->d->i => Aabc::$app->_model->__chinhsach, Aabc::$app->d->u =>'reca_gh','class' => 'btn btn-default bra', 'method' => 'POST']) ?>
</div>
