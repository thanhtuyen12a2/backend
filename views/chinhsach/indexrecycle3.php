...
$this->title = 'Chính sách giao hàng';
...
<p>
    ...
    $countgetAllRecycle1_3 = count($_Chinhsach::getAllRecycle1_3());
    
    if($countgetAllRecycle1_3 > 0){       
        echo '<button type="button"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1_3.'" '.Aabc::$app->d->u.' ="da_gh" class="btn btn-default bda" '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'"><span class="glyphicon glyphicon-ban-circle mden"></span>Xóa tất cả</button>';
    }
     ?>
        ...
        'columns' => [
            ...
            //],
             ...
             [                
                ...
                'value' => function ($model) {  
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1_3 = count($_Chinhsach::getAllRecycle1_3());                                      
                    return '<div class="text-center" ><button   '.Aabc::$app->d->type.'="_gh"   '.Aabc::$app->d->ct.' ="'.$countgetAllRecycle1_3.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="res_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="be glyphicon glyphicon-floppy-open" ></button></div>';                    
                }, 
            ],
            ...
            [           
                ...
                'value' => function ($model) {   
                    $_Chinhsach = Aabc::$app->_model->Chinhsach; 
                    $countgetAllRecycle1_3 = count($_Chinhsach::getAllRecycle1_3());                     
                    return '<div class="text-center" ><button   '.Aabc::$app->d->type.'="_gh"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1_3.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__chinhsach.'" '.Aabc::$app->d->u.' ="d_gh?id='.$model[Aabc::$app->_chinhsach->cs_id].'"  type="button" class="bd glyphicon glyphicon-ban-circle" ></button></div>'; 
                }, 
            ],
