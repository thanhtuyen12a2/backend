...
<div class="col-md-12  pt160">
    <?= $form->field($model, Html::encode(Aabc::$app->_chinhsach->cs_ten))->textArea(['placeholder' => 'VD: Bảo hành 1 năm tại cửa hàng' ,'maxlength' => true])->label('Tiêu đề')  ?>

    <i class="hdtip glyphicon glyphicon-info-sign" data-trigger="hover" data-placement="top" data-html="true" data-toggle="tooltip" data-original-title="- Tên chương trình chính sách." aria-invalid="false"></i>
</div>
...
<div class="col-md-12  pt160">
    ...
    <i class="hdtip glyphicon glyphicon-info-sign" data-trigger="hover" data-placement="top" data-html="true" data-toggle="tooltip" data-original-title="- Ghi chú chi tiết về chương trình chính sách." aria-invalid="false"></i>
</div>
