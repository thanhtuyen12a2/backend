...
<div class="col-md-12  pt100">
    <?= $form->field($model, Html::encode(Aabc::$app->_chinhsach->cs_ten))->textArea(['placeholder' => 'VD: Bảo hành 1 năm tại cửa hàng' ,'maxlength' => true])->label('Chính sách bảo hành')  ?>

    <i class="hdtip glyphicon glyphicon-info-sign" data-trigger="hover" data-placement="top" data-html="true" data-toggle="tooltip" data-original-title="- Tên chương trình bảo hành." aria-invalid="false"></i>
</div>
