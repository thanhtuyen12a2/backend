            ...
            <fieldset> 
                ...
                <p> 
                    <?php 
                        ...
                        $data_ts = $_Danhmuc::find()->andWhere(['dm_level' => 0, 'dm_dmsp' => $dmsp])->all();
                        $value_ts = Aabc::$app->request->get('nts');
                        if($data_ts){
                        ...
                        echo '<span>Nhóm Thông số</span>';                        
                        $value_ts = (!empty($value_ts) ? $value_ts : ['' => '--- Chọn ---']);
                        echo Html::dropDownList('nts', $value_ts , $data_ts , [                
                              // 'multiple'=>'multiple',
                              D::i =>  Aabc::$app->_model->__danhmuc,
                              D::ty => 'ra',
                              D::c => 'one',
                              ...
                              // D::t => 'sea',
                              'class' => 'mulr',
                              'id' =>  Aabc::$app->_model->__danhmuc.'_nts_select'
                          ]);
                    ?>

                    <script type="text/javascript">
                     $(document).ready(function(){                        
                        $('#danhmuc_nts_select-pa').click();
                    })
                    </script>
                 </p>
                ...
                <?php if(Aabc::$app->request->get('nts')){ ?>
                  <p> 
                    <?php 
                        $_Danhmuc = Aabc::$app->_model->Danhmuc;
                        ...
                        $nts = Aabc::$app->request->get('nts');
                        $data_ts = $_Danhmuc::find()->andWhere(['dm_level' => 1, 'dm_idcha' => $nts, 'dm_dmsp' => $dmsp])->all();
  ...
  <div class="content-right  col-md-10">
    ...
    <div class="content-right-top">       
        ...
        $demthungrac = count($_Danhmuc::getAllRecycle1_4());
          ...
          //Danh mục đã có thông số hay chưa, nếu có rồi thì ko thêm mới danh mục nữa
