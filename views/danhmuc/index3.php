  ...
  <div class="content-right  col-md-10">
    ...
    <div class="content-right-top">       
        ...
        $demthungrac = count($_Danhmuc::getAllRecycle1_3());
            ...
            echo '<button  '.Aabc::$app->d->m.' = "2"  type="button"  '.($demthungrac > 0 ? : 'disabled').'  id="mb'.Aabc::$app->_model->__danhmuc.'r" '.Aabc::$app->d->u.'="ir_dm" class="btn btn-danger mb" '.Aabc::$app->d->i.'= '.Aabc::$app->_model->__danhmuc .'><span class="glyphicon glyphicon-trash mden"></span>'.Aabc::$app->MyConst->view_btn_thungrac.' ('.$demthungrac.')</button>';
