        ...
        'columns' => [
             ...
             [                
                ...
                'value' => function ($model) {  
                    ...
                    return '<div class="text-center" ><button  '.Aabc::$app->d->type.'="_mn"  '.Aabc::$app->d->ct.' ="'.$countgetAllRecycle1_4.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__danhmuc.'" '.Aabc::$app->d->u.' ="res_mn?id='.$model[Aabc::$app->_danhmuc->dm_id].'"  type="button" class="be glyphicon glyphicon-floppy-open" ></button></div>';                    
                }, 
            ],
            ...
            [           
                ...
                'value' => function ($model) {   
                    $_Danhmuc = Aabc::$app->_model->Danhmuc; 
                    $countgetAllRecycle1_4 = count($_Danhmuc::getAllRecycle1_4());                     
                    return '<div class="text-center" ><button  '.Aabc::$app->d->type.'="_mn"  '.Aabc::$app->d->ct.'="'.$countgetAllRecycle1_4.'"  '.Aabc::$app->d->i.' ="'.Aabc::$app->_model->__danhmuc.'" '.Aabc::$app->d->u.' ="d_mn?id='.$model[Aabc::$app->_danhmuc->dm_id].'"  type="button" class="bd glyphicon glyphicon-ban-circle" ></button></div>'; 
                }, 
            ],
