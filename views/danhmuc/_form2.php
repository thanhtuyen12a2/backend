...
<div class="col-md-12 pt140">
    <?= $form->field($model, 'dm_email')->textInput(['maxlength' => true]) ?>    
</div>
<div class="col-md-12 pt140">
    <?= $form->field($model, 'dm_phone')->textInput(['maxlength' => true]) ?>    
</div>
<div class="col-md-12 pt140">
    <?= $form->field($model, 'dm_zalo')->textInput(['maxlength' => true]) ?>    
</div>
<div class="col-md-12 pt140">
    <?= $form->field($model, 'dm_skype')->textInput(['maxlength' => true]) ?>    
</div>
