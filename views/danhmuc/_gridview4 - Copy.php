            ...
            [                
                  ...
                  'value' => function ($model) { 
                      if($model[Aabc::$app->_danhmuc->dm_level] == 0 ){
                          return '<h4>'.Html::encode($model[Aabc::$app->_danhmuc->dm_char]).'</h4>';    
                      }else{
            ...
            //  Aabc::$app->_danhmuc->dm_groupmenu,
             ...
             [                
                ...
                'value' => function ($model) {                         
                    ...
                    <div class="gn"></div>
                    '.                        
                        (Aabc::$app->user->can('web') ?  ($model[Aabc::$app->_danhmuc->dm_status] == 2 ? '<button type="button" class="ml btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__danhmuc.'   '.Aabc::$app->d->u.'="us_mn?id='.$model[Aabc::$app->_danhmuc->dm_id].'">'.Aabc::$app->MyConst->gridview_menu_hienthi.'<span class="glyphicon glyphicon-eye-open"></span></button>' : '<button type="button" class="ml btn btn-default" '.Aabc::$app->d->i.'='.Aabc::$app->_model->__danhmuc.'   '.Aabc::$app->d->u.'="us_mn?id='.$model[Aabc::$app->_danhmuc->dm_id].'">'.Aabc::$app->MyConst->gridview_menu_an.'<span class="glyphicon glyphicon-eye-open"></span></button>') : "" )
